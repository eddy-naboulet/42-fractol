...
/*   Updated: 2016/05/07 14:20:08 by enaboule         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_choux_init(t_fctl *fctl)
{
	double	tmp;

	tmp = fctl->z_r;
	fctl->z_r = fabs(fctl->z_r * fctl->z_r - fctl->z_i * fctl->z_i + fctl->c_r);
	fctl->z_i = fabs(2 * fctl->z_i * tmp + fctl->c_i);
}
